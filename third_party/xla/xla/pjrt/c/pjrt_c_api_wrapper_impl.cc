...
PJRT_Error* PJRT_Executable_ParameterShardings(
    PJRT_Executable_ParameterShardings_Args* args) {
  PJRT_RETURN_IF_ERROR(ActualStructSizeIsGreaterOrEqual(
      "PJRT_Executable_ParameterShardings_Args",
      PJRT_Executable_ParameterShardings_Args_STRUCT_SIZE, args->struct_size));
...
PJRT_Api CreatePjrtApi(PJRT_Client_Create* create_fn,
  ...
  return PJRT_Api{
      ...
      pjrt::PJRT_Executable_ParameterShardings,
